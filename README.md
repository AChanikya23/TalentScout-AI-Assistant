...
Ensure Ollama is running on your machine, then open your terminal and run:
...
Usage Guide
Start the Chatbot: With your virtual environment activated, run the following command:

Bash
streamlit run app.py
Interact: The application will open in your default web browser. Greet the bot and follow its prompts to provide your details and tech stack.

Technical Screening: Answer the 3-5 technical questions the bot dynamically generates based on your stack.

End Conversation: Type "exit", "quit", or "bye" to gracefully end the chat.

Simulate Backend Storage: Open the sidebar on the left side of the UI and click "End Chat & Save Data". This triggers the backend pipeline to extract your data, anonymize it, and save it to the mock_database.json file.
...
Challenge: Context Hallucination and Rushing
...
Challenge: Ensuring GDPR Data Privacy with LLMs
